 ...
 ***************** */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_global_pwd:
            m_prefs.Global_pwd = !m_prefs.Global_pwd;
            item.setChecked(m_prefs.Global_pwd);
            if (item.isChecked())
                getGlobalPwd();
            return true;
...
// ========================================================================
    ...
    private void updateMenu() {
        ...
        m_menuGlobalPwd.setChecked(m_prefs.Global_pwd);
    ...
    private void optionsBox() {
        ...
        dlg.setContentView(R.layout.globalpwd_dlg);
    ...
    private void getGlobalPwd() {
        ...
        btn_ok.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                // m_prefParanoid = cb_paranoid.isChecked();
                m_prefs.save();
                dlg.dismiss();
            }
        });
